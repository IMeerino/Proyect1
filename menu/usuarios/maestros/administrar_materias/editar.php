...
$materias = "SELECT 
            idmateria,
            nombrem
            FROM materias WHERE idmateria = '$ID'";
            ...
            <form class="mt-5 mb-5" method="POST" action="<?php $_SERVER["PHP_SELF"]; ?>">
                ...
                <div class="alert alert-success w-50 mx-auto fw-bolder" role="alert">
                    ...
                    <div class="mb-3 mx-auto text-truncate">
                        ...
                        <input type="text" class="form-control" required name="nombrem" value="<?php echo $filas['nombrem']; ?>">
                    </div>
...
if(isset($_POST["editar"])){
    ...
    $id = $_POST["ID"];    
    $sqlmodificar = "UPDATE materias SET nombrem = '$nombremateria'
                    WHERE idmateria = '$id'";    
