...
$subtemas = "SELECT 
            ...
            nombresubtema, 
            descripcions
            FROM subtemas WHERE idsubtema = '$ID'";
$resultadosubtemas =$conexion->query($subtemas);
$filassubtema = $resultadosubtemas->fetch_assoc();
            ...
            <form class="mt-5 mb-5" method="POST" action="<?php $_SERVER["PHP_SELF"]; ?>">
                ...
                <div class="alert alert-success w-50 mx-auto fw-bolder" role="alert">
                    ...
                    <div class="mb-3 mx-auto text-truncate">
                        ...
                        <input type="text" class="form-control" required name="numsub" value="<?php echo $filassubtema['numerosubtema']; ?>">
                    </div>
                    <div class="mb-3 mx-auto text-truncate">
                        <label class="form-label">Nombre del Subtema</label>
                        <input type="text" class="form-control" required name="nomsub" value="<?php echo $filassubtema['nombresubtema']; ?>">
                    </div>
                    <div class="mb-3 mx-auto text-truncate">
                        <label class="form-label">Descripcion del Subtema</label>
                        <input type="text" class="form-control" required name="descsub" value="<?php echo $filassubtema['descripcions']; ?>">
                    </div>
...
<?php 
    ...
    if(isset($_POST["editar"])){
        $numesub = $_POST["numsub"];
        $nombsub = $_POST["nomsub"];
        $descripsub = $_POST["descsub"];
        $id = $_POST["ID"];    
        $sqlmodificar = "UPDATE subtemas SET numerosubtema = '$numesub',
                                            nombresubtema = '$nombsub',
                                            descripcions = '$descripsub'  
                        WHERE idsubtema = '$id'";    
