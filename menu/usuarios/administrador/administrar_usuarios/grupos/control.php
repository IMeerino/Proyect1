...
if (!empty($_POST)) {
    ...
    $tipou = 3;
    $nombreg = mysqli_real_escape_string($conexion, $_POST['nom']);
    $turnog = $_POST['turg'];
    $gradog = $_POST['grag'];
    $grupog = $_POST['grug'];
    

    $sqlusergrupo = "SELECT idusuario FROM usuarios WHERE nombreu = '$usuario'";
    $resultadousergrupo = $conexion->query($sqlusergrupo);
    $filasusergrupo = $resultadousergrupo->num_rows;
    ...
    if ($filasusergrupo > 0) {
        ...
        $sqlgrupo = "INSERT INTO usuarios(nombrecompleto,nombreu,contrau,idtipousuario)
                    VALUES('$nombrec','$usuario','$contra','$tipou')";
        $resultadogrupo = $conexion->query($sqlgrupo);

        $idusuariogrupo = $conexion->insert_id;

        $sqlgrupo = "INSERT INTO grupos(nombregrupo,turno,grado,grupo,idusuario)
                        VALUES('$nombreg','$turnog','$gradog','$grupog','$idusuariogrupo')";
        $resultadosqlgrupo = $conexion->query($sqlgrupo);
        ...
        <div class="contenedorcss">
            ...
            <form class="mt-5 mb-5" method="POST" action="<?php $_SERVER["PHP_SELF"]; ?>">
                ...
                <div class="alert alert-success w-50 mx-auto fw-bolder" role="alert">
                    ...
                    <div class="mb-3 mx-auto text-truncate">
                        Grado
                        <select class="form-select" aria-label="Default select example" required name="grag">
                    ...
                    <div class="mb-3 mx-auto text-truncate">
                        Grupo
                        <select class="form-select" aria-label="Default select example" required name="grug">
                            <option>A</option>
                            <option>B</option>
                            <option>C</option>
                            <option>D</option>
                    ...
                    <div class="mb-3 mx-auto text-truncate">
                        Turno
                        <select class="form-select" aria-label="Default select example" required name="turg">
            ...
            <div class="table-responsive rounded-3 mx-auto">
                ...
                <table class="table table-bordered">
                    ...
                    <thead class="table-dark table align-middle">
                        <tr>
                            <td class="bg-primary fs-5 fw-bold text-center" colspan="8">LISTA DE USUARIOS GRUPO</td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td>" . $regusuario['grado'] . "</td>
                        <td>" . $regusuario['grupo'] . "</td>
                        <td>" . $regusuario['turno'] . "</td>
