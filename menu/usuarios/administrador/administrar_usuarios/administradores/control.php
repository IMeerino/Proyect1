                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown">
                                <li><a class="dropdown-item" href="control.php">Administradores</a></li>
            ...
            <div class="table-responsive rounded-3 mx-auto">
                ...
                <table class="table table-bordered">
                    ...
                    <thead class="table-dark table align-middle">
                        <tr>
                            <td class="bg-primary fs-5 fw-bold text-center" colspan="5">LISTA DE USUARIOS ADMINISTRADOR</td>
                        </tr>
                        <tr>
